...
function ProccessQueue(steamID, discordID, d, _source)
	...
	PerformHttpRequest("https://discordapp.com/api/guilds/" .. Config.DiscordServerID .. "/members/"..string.sub(discordID, 9), function(err, text, headers) 
		if text ~= nil then
        	...
        	AddPlayer(steamID, discordID, "Member", 0, "None", _source, d)
		end
...
function GetMessage()
    ...
    cardd.body[3].text = "Utenti in coda: " .. tostring(#playersInfo) .. " | Conteggio giocatori: " .. #GetPlayers() .. "/" .. Config.maxServerSlots
